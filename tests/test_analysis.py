    ...
    def test_builds_factor_ic_analysis(self) -> None:
        factor_scores = [
            FactorScoreRecord(
                ...
                total_score=1.0,
                selected=True,
                raw_scores={"momentum": 0.1, "mean_reversion": 0.0, "low_volatility": 0.0},
                normalized_scores={"momentum": 1.0, "mean_reversion": 0.5, "low_volatility": 0.5},
            ),
            FactorScoreRecord(
                date=date(2024, 1, 2),
                symbol="600519",
                total_score=0.0,
                selected=False,
                raw_scores={"momentum": 0.0, "mean_reversion": 0.0, "low_volatility": 0.0},
                normalized_scores={"momentum": 0.0, "mean_reversion": 0.5, "low_volatility": 0.5},
            ),
            FactorScoreRecord(
                date=date(2024, 1, 3),
                symbol="000001",
