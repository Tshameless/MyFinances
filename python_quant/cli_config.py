...
def build_backtest_config(args: argparse.Namespace) -> BacktestConfig:
    ...
    config_kwargs: dict[str, object] = {
        ...
        "allocation_model": default_config.allocation_model,
        ...
        "twap_slices": default_config.twap_slices,
        ...
        "execution_style": default_config.execution_style,
...
def cli_config_overrides(args: argparse.Namespace) -> dict[str, object | None]:
    return {
        ...
        "allocation_model": getattr(args, "allocation_model", None),
        ...
        "twap_slices": getattr(args, "twap_slices", None),
        ...
        "execution_style": getattr(args, "execution_style", None),
...
def build_config_from_mapping(config_kwargs: Mapping[str, object]) -> BacktestConfig:
    return BacktestConfig(
        ...
        allocation_model=cast(str, config_kwargs["allocation_model"]),
        ...
        twap_slices=cast(int, config_kwargs["twap_slices"]),
        ...
        execution_style=cast(str, config_kwargs["execution_style"]),
